...
public class SitChair extends Action {
	...
	public int processWithDelay(Player player) {
		...
		player.setNextAnimation(new Animation(chair > 12 ? HouseConstants.THRONE_EMOTES[chair - 12] : chair > 6 ? HouseConstants.BENCH_EMOTES[chair - 6] : HouseConstants.CHAIR_EMOTES[chair]));
		return 0;
	}
