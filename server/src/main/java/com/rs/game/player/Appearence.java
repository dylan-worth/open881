...
public class Appearence implements Serializable {
	...
	public HeadIcon[] getIcons() {
		...
		/*
			...
			icons.add(new HeadIcon(1455, 1));
		else if(player.getRights() == 1)
			icons.add(new HeadIcon(1455, 0));
		else if (player.equals("p4"))
			icons.add(new HeadIcon(1455, 4));
		if (player.isHardcoreIronman())
			icons.add(new HeadIcon(1455, 13));
		if (player.isIronman())
			icons.add(new HeadIcon(1455, 11));
			*/
	...
	public int getRenderEmote() {
		...
		//int proudwalk = 3529;
		//int angrywalk = 3528;
		//int barbarienwalk = 3525;
		//int revenantwalk = 3600;
