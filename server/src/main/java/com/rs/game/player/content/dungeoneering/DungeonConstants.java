...
public class DungeonConstants {
	...
	public static final int[] MIN_CRIT_PATH = { 5, 10, 19 }, MAX_CRIT_PATH = { 7, 13, 23 };
	...
	public static final int[] LADDERS = new int[] { 49696, 49698, 49700, 53748, 55484 };
	 ...
	 * objects handling
	 */
	public static final int[] DUNGEON_DOORS = new int[] { 50342, 50343, 50344, 53948, 55762 };
	public static final int[] DUNGEON_BOSS_DOORS = new int[] { 50350, 50351, 50352, 53950, 55764 };
	...
	public static enum SkillDoors {
		RUNED_DOOR(Skills.RUNECRAFTING, new int[] { 50278, 50279, 50280, 53953, 55741 }, 791, 186, -1, -1, -1, -1, "You imbue the door with the wrong type of rune energy, and it reacts explosively."), BARRED_DOOR(Skills.STRENGTH, new int[] { 50272, 50273, 50274, 53951, 55739 }, new int[] { 50275, 50276, 50277, 53952, 55740 }, -1, -1, -1, -1, -1, -1, "You pull a muscle while attempting to move the plank."), PILE_OF_ROCKS(Skills.MINING, new int[] { 50305, 50306, 50307, 53962, 55750 }, -2, -1, 13559, -1, -1, 2420, "You fail to mine the obstruction, and are harmed by falling debris."), FLAMMABLE_DEBRIS(Skills.FIREMAKING, new int[] { 50314, 50315, 50316, 53965, 55753 }, 16700, -1, 13562, 13563, -1, -1, "The pile of debris fails to ignite. The same cannot be said for your clothes."), MAGICAL_BARRIER(Skills.MAGIC, new int[] { 50329, 50330, 50331, 53970, 55758 }, 4411, -1, 13551, 13550, -1, -1, "You fail to dispel the barrier and take a surge of magical energy to the face."), DARK_SPIRIT(Skills.PRAYER, new int[] { 50332, 50333, 50334, 53971, 55759 }, 645, -1, 13557, 13556, -1, -1, "The gods snub your prayer, and the dark spirit attacks you."), WOODEN_BARRICADE(Skills.WOODCUTTING, new int[] { 50317, 50318, 50319, 53966, 55754 }, new int[] { 50320, 50321, 50322, 53967, 55755 }, -3, -1, 13582, -1, -1, -1, "You swing the axe against the grain and are showered with sharp splinters of wood."), BROKEN_KEY_DOOR(Skills.SMITHING, new int[] { 50308, 50309, 50310, 53963, 55751 }, new int[] { 50311, 50312, 50313, 53964, 55752 }, 13759, -1, -1, -1, -1, -1, "You hit your hand with the hammer. Needless to say, the key is still broken."), BROKEN_PULLEY_DOOR(Skills.CRAFTING, new int[] { 50299, 50300, 50301, 53960, 55748 }, new int[] { 50302, 50303, 50304, 53961, 55749 }, 13547, -1, -1, -1, -1, -1, "The rope snaps again as you attempt to fix it, and you crush your hands in the mechanism."), LOCKED_DOOR(Skills.AGILITY, new int[] { -1, 50288, 50289, 53956, 55744 }, new int[] { 50290, 50291, 50292, 53957, 55745 }, 14550, -1, -1, -1, -1, -1, "You miss the chain, and set off the trap."), PADLOCKED_DOOR(Skills.THIEVING, new int[] { -1, 50294, 50295, 53958, 55746 }, new int[] { 50296, 50297, 50298, 53959, 55747 }, 14568, -1, -1, -1, 14569, -1, "You set off a booby trap inside the lock, and fail to pick it."), RAMOKEE_EXILE(Skills.SUMMONING, new int[] { -1, 50327, 50328, 53969, 55757 }, 725, 1207, -1, -1, -1, -1, "You fail to dismiss the rogue familiar, and it punches you in anger."), LIQUID_LOCK_DOOR(Skills.HERBLORE, new int[] { -1, 50336, 50337, 53972, 55760 }, new int[] { 50338, 50339, 50340, 53973, 55761 }, 14568, -1, -1, -1, -1, -1, "You incorrectly mix the ingredients, making it explode."), VINE_COVERED_DOOR(Skills.FARMING, new int[] { -1, 50324, 50325, 53968, 55756 }, 2275, -1, 13572, -1, -1, -1, "You hurt your hands on the vicious thorns covering the vines."), COLLAPSING_DOORFRAME(Skills.CONSTRUCTION, new int[] { -1, 50282, 50283, 53954, 55742 }, new int[] { 50284, 50285, 50286, 53955, 55743 }, 14566, -1, -1, -1, 14567, -1, "You dislodge some debris while attempting to fix the door, and it falls on you.");
	...
	public static final double[][] DUNGEON_DIFFICULTY_RATIO_BONUS = { { 0 }, { -0.07, 0.05 }, { -0.14, 0.02, 0.1 }, { -0.21, -0.07, 0.06, 0.15 }, { -0.29, -0.12, 0.04, 0.11, 0.19 } };
	/*
	 * floor types
	 */
	...
	public static final int[][] DUNGEON_RATIO = new int[][] { new int[] { 4, 4 }, new int[] { 4, 8 }, new int[] { 8, 8 }, new int[] { 2, 1 } };
	...
	public static final int[][] DANGEROUS_MUSICS = { { 832, 834, 827, 811, 824, 808, 831, 810, 833, 837 }, // frozen
	...
	public static final int[] SLAYER_CREATURES = { 10694, 10695, 10696, 10697, 10698, 10699, 10700, 10701, 10702, 10704, 10705 };

	/*
	 * id - lvl
	 */
	public static final int[] HUNTER_CREATURES = { 11086, 11087, 11088, 11089, 11090, 11091, 11092, 11093, 11094, 11095 };
	...
	public static enum MapRoomIcon {
		...
		MAP_1(2791, true, SOUTH_DOOR), MAP_2(2792, true, WEST_DOOR), MAP_3(2793, true, NORTH_DOOR), MAP_4(2794, true, EAST_DOOR), MAP_5(2795, true, WEST_DOOR, SOUTH_DOOR), MAP_6(2796, true, WEST_DOOR, NORTH_DOOR), MAP_7(2797, true, NORTH_DOOR, EAST_DOOR), MAP_8(2798, true, SOUTH_DOOR, EAST_DOOR), MAP_9(2799, true, SOUTH_DOOR, WEST_DOOR, NORTH_DOOR), MAP_10(2800, true, WEST_DOOR, NORTH_DOOR, EAST_DOOR), MAP_11(2801, true, SOUTH_DOOR, NORTH_DOOR, EAST_DOOR), MAP_12(2802, true, SOUTH_DOOR, WEST_DOOR, EAST_DOOR), MAP_13(2803, true, SOUTH_DOOR, NORTH_DOOR, EAST_DOOR, WEST_DOOR), MAP_14(2804, true, SOUTH_DOOR, NORTH_DOOR), MAP_15(2805, true, WEST_DOOR, EAST_DOOR), MAP_16(2787, false, SOUTH_DOOR), MAP_17(2788, false, WEST_DOOR), MAP_18(2789, false, NORTH_DOOR), MAP_19(2790, false, EAST_DOOR);
	...
	public static enum Puzzle {
		...
		CRYSTAL_PUZZLE(12, CrystalPuzzleRoom.class, all(spot(13, 5))), TOXIN_MAZE(20, ToxinMaze.class, all(spot(7, 8)), false), FLIP_TILES(24, FlipTilesRoom.class, list(spot(1, 3), spot(1, 12), spot(1, 3), spot(14, 11), spot(14, 11), spot(1, 9), spot(1, 3))), FREMENNIK_CAMP(26, FremennikCampRoom.class, list(spot(6, 14), spot(10, 2), spot(14, 6), spot(5, 12), spot(13, 10), spot(3, 5), spot(13, 10))), FISHING_FERRET(32, FishingFerretRoom.class, all(spot(2, 1)), false), LEVERS(38, LeverRoom.class, list(spot(1, 5), spot(10, 14), spot(1, 5), spot(10, 14), spot(1, 5), spot(10, 14), spot(1, 5))), SLIDING_STATUES(42, SlidingStatuesRoom.class, all(spot(1, 3)), false), FLOWER_ROOTS(50, FlowerRootsRoom.class, list(spot(9, 10), spot(6, 7), spot(13, 12), spot(12, 12), spot(3, 6), spot(2, 11), spot(3, 11)), false), POLTERGEIST(52, PoltergeistRoom.class, list(spot(1, 10), spot(2, 10), spot(3, 5), spot(2, 4), spot(13, 4), spot(2, 12), spot(3, 4))), UNHAPPY_GHOST(60, UnhappyGhostRoom.class, list(spot(2, 3), spot(3, 5), spot(3, 5), spot(2, 2), spot(3, 3), spot(2, 2), spot(4, 3)), false), RETURN_THE_FLOW(66, ReturnTheFlowRoom.class, list(spot(3, 3), spot(2, 12), spot(2, 2), spot(4, 2), spot(3, 3), spot(2, 2), spot(2, 2))), COLOURED_RECESS(68, ColouredRecessRoom.class, list(spot(2, 3), spot(2, 3), spot(2, 3), spot(2, 3), spot(2, 3), spot(2, 5), spot(2, 3)), false), SLIDING_TILES(76, SlidingTilesRoom.class, list(spot(1, 2), spot(13, 7), spot(1, 2), spot(13, 7), spot(1, 2), spot(13, 7), spot(1, 2)));
	...
	static {
		...
		for (Puzzle puzzle : Puzzle.values()) {
			...
			if (!Settings.HOSTED) {
				 ...
				 * else if(puzzle == Puzzle.COLOURED_RECESS) { //don't use in progress one on live instead replace
				 * it with last added one (more bug testers!) puzzle = Puzzle.SLIDING_STATUES; }
				 */
	...
	public static final int[][] WALL_BASE_X_Y = { { 14, 1, 0, 14 }, { 1, 1, 14, 0 }, { 1, 1, 0, 14 }, { 1, 14, 14, 0 } };
	...
	public static SmeltingBar[] SMELTING_BARS = new SmeltingBar[] { SmeltingBar.NOVITE, SmeltingBar.BATHUS, SmeltingBar.MARMAROS, SmeltingBar.KRATONITE, SmeltingBar.FRACTITE, SmeltingBar.ZEPHYRIUM, SmeltingBar.ARGONITE, SmeltingBar.KATAGON, SmeltingBar.GORGONITE, SmeltingBar.PROMETHIUM };

	public static int[] GROUP_GATESTONE_RUNES = { 17792, 3 };

	public static final int[][] HOARDSTALKER_ITEMS = { { 17630, 17424, 17682, 17448, 17797 }, { 17632, 17426, 17684, 17450, 17799 }, { 17634, 17428, 17686, 17452, 17801 }, { 17636, 17430, 17688, 17454, 17803 }, { 17638, 17432, 17700, 17456, 17805 }, { 17640, 17434, 17702, 17458, 17807 }, { 17642, 17436, 17704, 17460, 17809 }, { 17644, 17438, 17706, 17462, 17811 }, { 17646, 17440, 17708, 17464, 17813 }, { 17648, 17442, 17710, 17466, 17815 }, };
