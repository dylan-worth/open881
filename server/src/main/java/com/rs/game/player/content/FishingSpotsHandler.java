...
public class FishingSpotsHandler {
	...
	public static void init() {
		...
		moveSpots.put(new WorldTile(3238, 3255, 0).getTileHash(), new WorldTile(3239, 3242, 0).getTileHash());
		moveSpots.put(new WorldTile(3239, 3243, 0).getTileHash(), new WorldTile(3238, 3254, 0).getTileHash());
		/* Draynor Fishing Spots */
		moveSpots.put(new WorldTile(3086, 3228,0).getTileHash(), new WorldTile(3085,3231, 0).getTileHash());
		moveSpots.put(new WorldTile(3085,3230,0).getTileHash(), new WorldTile(3087,3224,0).getTileHash());
		/* Lava Eel */
		moveSpots.put(new WorldTile(2889, 9766, 0).getTileHash(), new WorldTile(2891, 9766, 0).getTileHash());
