...
public final class Woodcutting extends Action {
	...
	public static enum TreeDefinitions {
		...
		NORMAL(1, 25, 1511, 20, 4, 1341, Utils.random(50,100), 0), // TODO

		DRAMEN(36, 1, 771, 20, 4, -1, Utils.random(50,100), 0),

		EVERGREEN(1, 25, 1511, 20, 4, 57931, Utils.random(50,100), 0),

		DEAD(1, 25, 1511, 20, 4, 12733, Utils.random(50,100), 0),

		OAK(10, 37.5, 1521, 30, 4, 1341, Utils.random(14,16), 15), // TODO

		WILLOW(20, 67.5, 1519, 60, 4, 5554, 14, 15), // TODO

		TEAK(30, 85, 6333, 30, 4, 9037, 100, 10),

		MAPLE(40, 100, 1517, 83, 16, 31057, 72, 10),
		...
		* StumpId:
		* Respawn Delay: 13.2
		* Random Life Probability:
		* */
		MAHOGANY(60, 125, 6332, 95, 16, 9035, 100, 10),

		YEW(70, 175, 1515, 120, 17, 7402, 100, 10), // TODO

		IVY(70, 332.5, -1, 120, 17, 46319, 58, 10),

		MAGIC(80, 250, 1513, 150, 21, 37824, 120, 10),

		CURSED_MAGIC(90, 250, 1513, 150, 21, 37822, 120, 10),
	...
	public int processWithDelay(Player player) {
		...
		if (!usedDeplateAurora && (1 + Math.random()) < player.getAuraManager().getChanceNotDepleteMN_WC()) {
			...
			if (tree.getPlane() < 3 && definitions != TreeDefinitions.IVY) {
				...
				if (object != null)
					World.removeObjectTemporary(object, (int) time);
			}
