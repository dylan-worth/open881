...
public final class Mining extends MiningBase {
	...
	public static enum RockDefinitions {
		...
		Copper_Ore(1, 17.5, 436, 10, 1, 11552, Utils.random(3, 4), 0),

		Tin_Ore(1, 17.5, 438, 15, 1, 11552, Utils.random(3, 4), 0),

		Clay_Ore(1, 5, 434, 10, 1, 11552, 2, 0),

		Blurite_Ore(10, 17.5, 668, 15, 1, 11552, 7, 0),

		Iron_Ore(15, 35, 440, 15, 1, 11552, Utils.random(8, 9), 0),

		Sandstone_Ore(35, 30, 6971, 30, 1, 11552, 10, 0),

		Silver_Ore(20, 40, 442, 25, 1, 11552, 100, 0),

		Coal_Ore(30, 50, 453, 50, 10, 11552, Utils.random(46,47), 0),

		Granite_Ore(45, 50, 6979, 50, 10, 11552, 20, 0),

		Gold_Ore(40, 65, 444, 80, 20, 11554, 100, 0),

		Mithril_Ore(55, 80, 447, 100, 20, 11552, Utils.random(203, 204), 0),

		Adamant_Ore(70, 95, 449, 130, 25, 11552, Utils.random(416,417), 0),

		Runite_Ore(85, 125, 451, 150, 30, 11552, 1000, 0),

		LRC_Coal_Ore(77, 50, 453, 50, 10, -1, -1, -1),

		LRC_Gold_Ore(80, 260, 444, 40, 10, -1, -1, -1),

		Seren_Stone(89, 296.7, 32262, 100, 20, -1, -1, -1),
	...
	private int getMiningDelay(Player player) {
		...
		mineTimer /= player.getAuraManager().getMiningAccuracyMultiplier();
		return mineTimer;
	}
