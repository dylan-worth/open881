		...
		WorldTasksManager.schedule(new WorldTask() {
			...
			public void run() {
				if (stage == 1) {
					...
					player.setRun(false);
					player.getPackets().sendCameraPosition(Cutscene.getX(player, getBaseX() + 23), Cutscene.getY(player, getBaseY() + 8), 2500, 4, 4);
					...
					player.getPackets().sendCameraPosition(Cutscene.getX(player, getBaseX() + 16), Cutscene.getY(player, getBaseY() + 8), 2500, 4, 4);
					...
					player.getPackets().sendCameraPosition(Cutscene.getX(player, getBaseX() + 16), Cutscene.getY(player, getBaseY() + 14), 1800, 6, 6);
				} else if (stage == 20) {
		...
		WorldTasksManager.schedule(new WorldTask() {
			...
			public void run() {
				if (stage == 1) {
					...
					player.getPackets().sendAddObject(new WorldObject(48073, 10, 0, getBaseX() + 14, getBaseY() + 22, 0));
					player.unlock();
					player.setRun(true);
					stop();
				}
