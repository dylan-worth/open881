...
public final class LevelUp extends Dialogue {
	 ...
	 * 650000000, 600000000, 700000000, 1400000000, 1450000000, 850000000, 1500000000, 1600000000, 1650000000,
	 * 1700000000 };
	 */
	...
	public void start() {
		...
		player.getInterfaceManager().sendDialogueInterface(740);
	...
	public static void switchFlash(Player player, int skill, boolean on) {
		...
		if (skill == Skills.ATTACK)
			...
			id = 7756;
		player.getVarsManager().sendVarBitOld(id, on ? 1 : 0);
	}
