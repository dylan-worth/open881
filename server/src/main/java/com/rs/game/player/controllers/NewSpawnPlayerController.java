...
public class NewSpawnPlayerController extends Controller {
	...
	public boolean processObjectClick1(WorldObject object) {
		int id = object.getId();
		if ((id == 47120 && getStage() == 3) || (Wilderness.isDitch(id) && getStage() == 4))
			return true;
		return false;
	}
	...
	public void sendInterfaces() {
		...
		if (stage == 2) {
			...
			player.getPackets().sendIComponentText(372, 2, "Oracle of Dawn in this room .He is indicated by a flashing");
	...
	public void forceClose() {
		...
		player.getPackets().sendGameMessage("If you have questions, please talk to Oracle of Dawn.");
		if (Settings.HOSTED)
