...
public class BattlestaffCrafting extends Action {
	...
	public enum CraftStaffAction {
		...
		WATER_BATTLESTAFF(54, 100, 16448, new Item[] { new Item(571), new Item(1391) }, new Item(1395),
				Skills.CRAFTING), EARTH_BATTLESTAFF(58, 112.5, 16447, new Item[] { new Item(575), new Item(1391) },
						new Item(1399),
						Skills.CRAFTING), FIRE_BATTLESTAFF(62, 125, 16449, new Item[] { new Item(569), new Item(1391) },
								new Item(1393), Skills.CRAFTING), AIR_BATTLESTAFF(66, 137.5, 16446,
										new Item[] { new Item(573), new Item(1391) }, new Item(1397),
										Skills.CRAFTING), ARMADYL_BATTLESTAFF(77, 150, 16450,
												new Item[] { new Item(21775), new Item(1391) }, new Item(21777),
												Skills.CRAFTING);
		...
		private CraftStaffAction(int levelRequired, double experience, int emote, Item[] itemsRequired,
	...
	public boolean process(Player player) {
		...
		if (player.getSkills().getLevel(craft.getSkillType()) < craft.getLevelRequired()) {
			player.getDialogueManager().startDialogue("SimpleMessage",
					"You need a Crafting level of " + craft.getLevelRequired() + " to cut that gem.");
			return false;
		}
		return true;
	}
