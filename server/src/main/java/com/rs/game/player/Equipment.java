...
public final class Equipment implements Serializable {
	...
	public static final byte SLOT_POCKET = 17;

	public static final byte SLOT_WINGS = 15;
	...
	public Equipment() {
		...
		cosmeticItems = new ItemsContainer<Item>(BodyDefinitions.getEquipmentContainerSize(), false);
	}
	...
	public void sendExamine(int slotId) {
		...
		if (item == null)
			return;
		player.getPackets().sendInterfaceMessage(1464, 15, 0, slotId,
			...
			case Equipment.SLOT_CAPE:
				if (packetId == WorldPacketsDecoder.ACTION_BUTTON9_PACKET) {
					...
					if (capeId == 32151 || capeId == 20767) {
						Magic.sendTeleportSpell(player, 8939, 8941, 1576, 1577, 1, 0, new WorldTile(2276, 3313, 1), 4,
								false, Magic.ITEM_TELEPORT);
