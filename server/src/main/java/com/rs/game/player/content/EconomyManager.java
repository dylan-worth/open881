	...
	public static void processManagerNpcClick(final Player player, final int npcId) {
		...
		player.getDialogueManager().startDialogue(new Dialogue() {
			...
			private void setTitlePage() {
				setPage(0, "Welcome to " + Settings.SERVER_NAME + "!<br>I provide various services to make your life here easier.", "Information & Links", "Account & Character management", (tileEventHappening || surpriseEvent != null) ? "Teleports (Click here for event)" : "Teleports", "Dungeoneering", "Shops", "Vote", "Donate", "Submit a ticket", "Close Oracle");
			}
