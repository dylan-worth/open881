...
public class NPCCombatDefinitions {
	...
	public NPCCombatDefinitions(int hitpoints, int attackAnim, int defenceAnim, int deathAnim, int respawnDelay, int attackGfx, int attackProjectile, double xp, boolean followClose, boolean poisonImmune, boolean poisonous, boolean agressive, int agroRatio) {
	...
	public int getDeathDelay() {
		return (AnimationDefinitions.getAnimationDefinitions(deathAnim).getEmoteClientCycles() / 30) - 1;
	}
